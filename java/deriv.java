...
public class deriv {
  ...
  static Expr add( Expr x, Expr y ) {
    if (x instanceof ValExpr a && y instanceof ValExpr b) {
      ...
      return add(new ValExpr(b.value), x);
    }
    ...
    else if (y instanceof AddExpr b && b.left instanceof ValExpr bl) {
      return add(new ValExpr(bl.value), add(x,b.right));
    }
  ...
  static Expr mul( Expr x, Expr y ) {
    if (x instanceof ValExpr a && y instanceof ValExpr b) {
      ...
      return mul(new ValExpr(b.value),x);
    }
    ...
    else if (y instanceof MulExpr b && b.left instanceof ValExpr bl) {
      return mul(new ValExpr(bl.value), mul(x,b.right));
    }
